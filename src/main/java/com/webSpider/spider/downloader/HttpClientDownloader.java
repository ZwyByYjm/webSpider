package com.webSpider.spider.downloader;
...
import static com.webSpider.spider.process.MusicListInfoProcess.IPS;
 ...
 */
@ThreadSafe
public class HttpClientDownloader extends us.codecraft.webmagic.downloader.AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            //System.out.println("download FOR IP "+site.getHttpProxy().toHostString());
...
//                System.out.println("LPush:" + request.getExtra("queue_" + "RedisSuffix").toString() + "###" +request.getUrl().toString());
                return null;
            }
        } catch (IOException e) {
            ...
            if (site.getCycleRetryTimes() > 0) {
                ...
                site.setHttpProxy(IPS[new Random().nextInt(6)]);
